...
# train_dataset_directory = 'asl_alphabet_train/asl_alphabet_train'
# test_dataset_directory = 'asl_alphabet_test/asl_alphabet_test'

# train_images, train_labels = load_train_images(train_dataset_directory, image_size)
# test_images, test_labels = load_test_images(test_dataset_directory, image_size)

train_images, train_labels = load_train_images('asl-alphabet/asl_alphabet_train', image_size)
test_images, test_labels = load_test_images('asl-alphabet/asl_alphabet_test', image_size)
